...
IntelliJ IDEA avec GitHub Copilot (licence équipe) ou Junie installé.

---

## Lancement

**Participants** → ouvrir `docs/getting-started.md` en premier.  
**Animateur** → ouvrir `docs/feuille-animateur.md`.
